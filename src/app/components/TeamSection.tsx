...
import imgUserCover1 from "@/imports/SchoolSound/98dd6fddf1cbafa97cd4ea6d114669d49b45cd1d.png";
import imgUserCover2 from "@/imports/SchoolSound/221b7e3a6874f6ad6cc31d849fce5c3489d88d9e.png";
import imgUserCover3 from "@/imports/SchoolSound/3a771bafa5a1b06d59940a9c6c60ee827033e6d8.png";
import imgUserCover4 from "@/imports/SchoolSound/00d9ea69788677fb8424863333e49c497e1680c6.png";
      ...
      <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-[20px] shadow-[0px_13px_19px_0px_rgba(0,0,0,0.07)] shrink-0 w-full">
        <div className="h-[231px] overflow-clip relative shrink-0 w-full">
          <div className="absolute h-[231px] left-0 right-0 top-0">
            <img alt="Team member" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={image} />
          </div>
        </div>
        <div className="content-stretch flex flex-col gap-[10px] items-center overflow-clip p-[30px] relative shrink-0 w-[232px]">
          <p className="[word-break:break-word] font-['Montserrat:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#252b42] text-[16px] text-center tracking-[0.1px] whitespace-nowrap">Julian Jameson</p>
          <p className="[word-break:break-word] font-['Montserrat:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#737373] text-[12px] text-center tracking-[0.2px] whitespace-nowrap">Profession</p>
          <SocialIcons />
        </div>
      </div>
    </div>
...
export default function TeamSection() {
  return (
    <section id="team" className="bg-white h-[849px] overflow-clip relative shrink-0 w-[1440px]">
      <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[112px] items-center left-1/2 py-[112px] top-0 w-[1050px]">
        {/* Heading */}
        <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[1044px]">
          <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start overflow-clip relative shrink-0 w-[691px] whitespace-nowrap">
            <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#96bb7c] text-[14px] tracking-[0.2px]">Team</p>
            <p className="font-['Montserrat:Bold',sans-serif] font-bold leading-[32px] relative shrink-0 text-[#252b42] text-[24px] tracking-[0.1px]">Get Quality Education</p>
