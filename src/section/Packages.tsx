...
function FeatureCard({
  ...
  return (
    <div className="bg-white content-stretch flex flex-col gap-[20px] items-start overflow-clip px-[40px] py-[35px] relative shadow-[0px_13px_19px_0px_rgba(0,0,0,0.07)] shrink-0 w-[249px]">
      ...
      <p className="[word-break:break-word] font-['Montserrat:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#252b42] text-[16px] tracking-[0.1px] w-[157px]">
        {title}
      </p>
...
export default function Packages() {
  ...
  return (
    <>
      <section id="pricing" className="bg-white relative shrink-0 w-[1440px]">
        <div className="content-stretch flex flex-col items-start mx-auto pt-[160px] w-[1050px]">
          <div className="content-stretch flex gap-[30px] items-center relative shrink-0">
            ...
            <div className="content-stretch flex flex-col gap-[35px] items-start overflow-clip relative shrink-0 w-[507px]">
              ...
              <p className="[word-break:break-word] font-['Montserrat:Bold',sans-serif] font-bold leading-[50px] relative shrink-0 text-[#252b42] text-[40px] tracking-[0.2px] whitespace-nowrap">
                Approdable Packages
              </p>
              <div className="[word-break:break-word] font-['Montserrat:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[#737373] text-[14px] tracking-[0.2px] whitespace-nowrap">
            ...
            <div className="content-stretch flex gap-[30px] items-start relative shrink-0 min-h-[320px] w-[508px]">
