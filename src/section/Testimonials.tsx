...
import imgTestimonialUserCover1 from "@/assets/a0cb5ac673461df16e658c9906c9fcab54731708.png";
import imgTestimonialUserCover2 from "@/assets/b7980d6f6dfb3f6c6ec9b6e9414e4ea754b2d1fd.png";
              ...
              <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
                <div className="content-stretch flex flex-col gap-[15px] items-center p-[30px] relative size-full">
                  ...
                  <div className="[word-break:break-word] content-stretch flex flex-col font-['Montserrat:Bold',sans-serif] font-bold gap-[5px] items-center leading-[24px] overflow-clip px-[25px] relative shrink-0 text-center whitespace-nowrap">
                    ...
                    <p className="relative shrink-0 text-[#737373] text-[14px] tracking-[0.2px]">
                      Designer
                    </p>
                  </div>
                </div>
...
export default function TestimonialsPage() {
  return (
    <section
      id="testimonials"
      className="bg-white relative w-max p-[50px] box-border"
    >
      <div className="content-stretch flex flex-col gap-[96px] items-center relative w-[1050px] min-w-[1050px]">
        {/* Heading */}
